...
if(opts.multiple || ($.trim(_b3c)!=null && $.trim(_b3c)!="")){
...
var opts=$(_b40).tagbox("options");
var tbt=$(_b40).tagbox("textbox");
...
(function($){
var _ca1=0;
function _ca2(_ca3,separator,suffix){
$(_ca3).addClass("textbox-f").hide();
var jj=[];
...
jj.push("<input type=\"hidden\" class=\"textbox-value\">");
jj.push("</span>");
var _ca4=$(jj.join("")).insertAfter(_ca3);
_ca4.find(".textbox-separator").css({margin:"0px 5px",padding:"0px",display:"inline-block",verticalAlign:"middle",position:"relative",width:"auto",height:"100%"});
var _ca5=$(_ca3).attr("name");
if(_ca5){
_ca4.find("input.textbox-value:eq(0)").attr("name",_ca5);
$(_ca3).removeAttr("name").attr("textboxName",_ca5);
}
var _can2=$(_ca3).attr("name2");
if(!_can2 && _ca5) _can2=_ca4+suffix;
if(_can2){
_ca4.find("input.textbox-value:eq(1)").attr("name",_can2);
$(_ca3).removeAttr("name2").attr("textboxName2",_can2);
}
return _ca4;
};
function _ca6(_ca7){
var _ca8=$.data(_ca7,"doubletextbox");
var _ca9=_ca8.options;
var tb=_ca8.doubletextbox;
var _caa="_caeasyui_catextbox_cainput"+(++_ca1);
var _caa2="_caeasyui_catextbox_cainput"+(++_ca1);
tb.addClass(_ca9.cls);
tb.find(".textbox-text").remove();
$("<input id=\""+_caa2+"\" type=\""+_ca9.type+"\" class=\"textbox-text\" autocomplete=\"off\">").prependTo(tb);
tb.find(".textbox-separator").remove();
$("<span class=\"textbox-separator\">"+_ca9.separator+"</span>").css({margin:"0px 5px",padding:"0px",display:"inline-block",verticalAlign:"middle",position:"relative",width:"auto",height:"100%"}).prependTo(tb);
$("<input id=\""+_caa+"\" type=\""+_ca9.type+"\" class=\"textbox-text\" autocomplete=\"off\">").prependTo(tb);
$("#"+_caa).attr("tabindex",$(_ca7).attr("tabindex")||"").css("text-align",_ca7.style.textAlign||"");
$("#"+_caa2).attr("tabindex",$(_ca7).attr("tabindex")||"").css("text-align",_ca7.style.textAlign||"");
tb.find(".textbox-addon").remove();
var bb=_ca9.icons?$.extend(true,[],_ca9.icons):[];
if(_ca9.iconCls){
bb.push({iconCls:_ca9.iconCls,disabled:true});
}
if(bb.length){
var bc=$("<span class=\"textbox-addon\"></span>").prependTo(tb);
bc.addClass("textbox-addon-"+_ca9.iconAlign);
for(var i=0;i<bb.length;i++){
bc.append("<a href=\"javascript:;\" class=\"textbox-icon "+bb[i].iconCls+"\" icon-index=\""+i+"\" tabindex=\"-1\"></a>");
}
}
tb.find(".textbox-button").remove();
if(_ca9.buttonText||_ca9.buttonIcon){
var _cab=$("<a href=\"javascript:;\" class=\"textbox-button\"></a>").prependTo(tb);
_cab.addClass("textbox-button-"+_ca9.buttonAlign).linkbutton({text:_ca9.buttonText,iconCls:_ca9.buttonIcon,onClick:function(){
var t=$(this).parent().prev();
t.doubletextbox("options").onClickButton.call(t[0]);
}});
}
if(_ca9.label){
if(typeof _ca9.label=="object"){
_ca8.label=$(_ca9.label);
_ca8.label.attr("for",_caa);
}else{
$(_ca8.label).remove();
_ca8.label=$("<label class=\"textbox-label\"></label>").html(_ca9.label);
_ca8.label.css("textAlign",_ca9.labelAlign).attr("for",_caa);
if(_ca9.labelPosition=="after"){
_ca8.label.insertAfter(tb);
}else{
_ca8.label.insertBefore(_ca7);
}
_ca8.label.removeClass("textbox-label-left textbox-label-right textbox-label-top");
_ca8.label.addClass("textbox-label-"+_ca9.labelPosition);
}
}else{
$(_ca8.label).remove();
}
_cac(_ca7);
_cad(_ca7,_ca9.disabled);
_cae(_ca7,_ca9.readonly);
};
function _caf(_ca10){
var tb=$.data(_ca10,"doubletextbox").doubletextbox;
tb.find(".textbox-text").validatebox("destroy");
tb.remove();
$(_ca10).remove();
};
function _ca11(_ca12,_ca13){
var _ca14=$.data(_ca12,"doubletextbox");
var _ca15=_ca14.options;
var tb=_ca14.doubletextbox;
var _ca16=tb.parent();
if(_ca13){
if(typeof _ca13=="object"){
$.extend(_ca15,_ca13);
}else{
_ca15.width=_ca13;
}
}
if(isNaN(parseInt(_ca15.width))){
var c=$(_ca12).clone();
c.css("visibility","hidden");
c.insertAfter(_ca12);
_ca15.width=c.outerWidth();
c.remove();
}
var _ca17=tb.is(":visible");
if(!_ca17){
tb.appendTo("body");
}
var _ca18=tb.find(".textbox-text");
var btn=tb.find(".textbox-button");
var _ca19=tb.find(".textbox-addon");
var _ca1a=_ca19.find(".textbox-icon");
var separator=tb.find(".textbox-separator");
if(_ca15.height=="auto"){
_ca18.css({margin:"",paddingTop:"",paddingBottom:"",height:"",lineHeight:""});
}
tb._size(_ca15,_ca16);
if(_ca15.label&&_ca15.labelPosition){
if(_ca15.labelPosition=="top"){
_ca14.label._size({width:_ca15.labelWidth=="auto"?tb.outerWidth():_ca15.labelWidth},tb);
if(_ca15.height!="auto"){
tb._size("height",tb.outerHeight()-_ca14.label.outerHeight());
}
}else{
_ca14.label._size({width:_ca15.labelWidth,height:tb.outerHeight()},tb);
tb._size("width",tb.outerWidth()-_ca14.label.outerWidth());
}
}
if(_ca15.buttonAlign=="left"||_ca15.buttonAlign=="right"){
btn.linkbutton("resize",{height:tb.height()});
}else{
btn.linkbutton("resize",{width:"100%"});
}
var _ca1b=tb.width()-_ca1a.length*_ca15.iconWidth-_ca1c("left")-_ca1c("right")-separator.outerWidth(true);
var _ca1d=_ca15.height=="auto"?_ca18.outerHeight():(tb.height()-_ca1c("top")-_ca1c("bottom"));
_ca19.css(_ca15.iconAlign,_ca1c(_ca15.iconAlign)+"px");
_ca19.css("top",_ca1c("top")+"px");
_ca1a.css({width:_ca15.iconWidth+"px",height:_ca1d+"px"});
_ca18.css({paddingLeft:(_ca12.style.paddingLeft||""),paddingRight:(_ca12.style.paddingRight||""),marginLeft:0,marginRight:0,marginTop:_ca1c("top"),marginBottom:_ca1c("bottom")});
_ca18.first().css({marginLeft:_ca1e("left"),marginRight:0});
_ca18.last().css({marginLeft:0,marginRight:_ca1e("right")});
_ca18.css({paddingTop:0,paddingBottom:0,height:_ca1d+"px",lineHeight:_ca1d+"px"});
separator.css({paddingTop:0,paddingBottom:0,height:_ca1d+"px",lineHeight:_ca1d+"px"});
_ca18._outerWidth(_ca1b/2);
_ca15.onResizing.call(_ca12,_ca15.width,_ca15.height);
if(!_ca17){
tb.insertAfter(_ca12);
}
_ca15.onResize.call(_ca12,_ca15.width,_ca15.height);
function _ca1e(_ca1f){
return (_ca15.iconAlign==_ca1f?_ca19._outerWidth():0)+_ca1c(_ca1f);
};
function _ca1c(_ca20){
var w=0;
btn.filter(".textbox-button-"+_ca20).each(function(){
if(_ca20=="left"||_ca20=="right"){
w+=$(this).outerWidth();
}else{
w+=$(this).outerHeight();
}
...
function _cac(_ca21){
var _ca22=$(_ca21).doubletextbox("options");
var _ca23=$(_ca21).doubletextbox("doubletextbox");
var _ca23o=$.extend({},_ca22,{deltaX:function(_ca24){
return $(_ca21).doubletextbox("getTipX",_ca24);
},deltaY:function(_ca25){
return $(_ca21).doubletextbox("getTipY",_ca25);
},onBeforeValidate:function(){
_ca22.onBeforeValidate.call(_ca21);
var box=$(this);
if(!box.is(":focus")){
var i = box.index(".textbox-text");
if(i==1){
if(box.val()!==_ca22.valueEnd){
_ca22.oldInputValueEnd=box.val();
box.val(_ca22.valueEnd);
}
}else{
if(box.val()!==_ca22.valueBegin){
_ca22.oldInputValueBegin=box.val();
box.val(_ca22.valueBegin);
}
}
}
},onValidate:function(_ca26){
var box=$(this);
var i = box.index(".textbox-text");
if(i==1){
if(_ca22.oldInputValueEnd!=undefined){
box.val(_ca22.oldInputValueEnd);
_ca22.oldInputValueEnd=undefined;
}
}else{
if(_ca22.oldInputValueBegin!=undefined){
box.val(_ca22.oldInputValueBegin);
_ca22.oldInputValueBegin=undefined;
}
}
var tb=box.parent();
if(_ca26){
...
_ca22.onValidate.call(_ca21,_ca26);
},err:function(target, message, action){
if($.isFunction(_ca22.err)){
_ca22.err(target,message,action);
}
},
val:function(t){
return $(t).val();
}});
_ca23.first().validatebox($.extend({},_ca23o,{value:$(_ca21).doubletextbox("getTextBegin")}));
_ca23.last().validatebox($.extend({},_ca23o,{value:$(_ca21).doubletextbox("getTextEnd")}));
};
function _ca27(_ca28){
var _ca29=$.data(_ca28,"doubletextbox");
var _ca2a=_ca29.options;
var tb=_ca29.doubletextbox;
var _ca2b=tb.find(".textbox-text");
_ca2b.first().attr("placeholder",_ca2a.promptBegin);
_ca2b.last().attr("placeholder",_ca2a.promptEnd);
_ca2b.unbind(".textbox");
$(_ca29.label).unbind(".textbox");
if(!_ca2a.disabled&&!_ca2a.readonly){
if(_ca29.label){
$(_ca29.label).bind("click.textbox",function(e){
if(!_ca2a.hasFocusMe){
_ca2b.focus();
$(_ca28).doubletextbox("setSelectionRange",{start:0,end:_ca2b.val().length});
}
});
}
_ca2b.bind("blur.textbox",function(e){
if(!tb.hasClass("textbox-focused")){
return;
}
_ca7a(this,e);
...
for(var _ca2c in _ca2a.inputEvents){
_ca2b.bind(_ca2c+".textbox",{target:_ca28},_ca2a.inputEvents[_ca2c]);
}
function _ca7a(_ca7b,e){
var i = $(e.target).index(".textbox-text");
if(i==1){
_ca2a.valueEnd=$(_ca7b).val();
if(_ca2a.valueEnd==""){
$(_ca7b).val(_ca2a.promptEnd).addClass("textbox-prompt");
}else{
$(_ca7b).removeClass("textbox-prompt");
}
}else{
_ca2a.valueBegin=$(_ca7b).val();
if(_ca2a.valueBegin==""){
$(_ca7b).val(_ca2a.promptBegin).addClass("textbox-prompt");
}else{
$(_ca7b).removeClass("textbox-prompt");
}
}
...
var _ca2d=tb.find(".textbox-addon");
_ca2d.unbind().bind("click",{target:_ca28},function(e){
var _ca2e=$(e.target).closest("a.textbox-icon:not(.textbox-icon-disabled)");
if(_ca2e.length){
var _ca2f=parseInt(_ca2e.attr("icon-index"));
var _ca30=_ca2a.icons[_ca2f];
if(_ca30&&_ca30.handler){
_ca30.handler.call(_ca2e[0],e);
}
_ca2a.onClickIcon.call(_ca28,_ca2f);
}
});
_ca2d.find(".textbox-icon").each(function(_ca31){
var _ca32=_ca2a.icons[_ca31];
var _ca33=$(this);
if(!_ca32||_ca32.disabled||_ca2a.disabled||_ca2a.readonly){
_ca33.addClass("textbox-icon-disabled");
}else{
_ca33.removeClass("textbox-icon-disabled");
}
});
var btn=tb.find(".textbox-button");
btn.linkbutton((_ca2a.disabled||_ca2a.readonly)?"disable":"enable");
tb.unbind(".textbox").bind("_caresize.textbox",function(e,_ca34){
if($(this).hasClass("easyui-fluid")||_ca34){
_ca11(_ca28);
}
return false;
});
};
function _cad(_ca35,_ca36){
var _ca37=$.data(_ca35,"doubletextbox");
var _ca38=_ca37.options;
var tb=_ca37.doubletextbox;
var _ca39=tb.find(".textbox-text");
var ss=$(_ca35).add(tb.find(".textbox-value"));
_ca38.disabled=_ca36;
if(_ca38.disabled){
_ca39.blur();
_ca39.validatebox("disable");
tb.addClass("textbox-disabled");
ss.attr("disabled","disabled");
$(_ca37.label).addClass("textbox-label-disabled");
}else{
_ca39.validatebox("enable");
tb.removeClass("textbox-disabled");
ss.removeAttr("disabled");
$(_ca37.label).removeClass("textbox-label-disabled");
}
};
function _cae(_ca3a,_ca3b){
var _ca3c=$.data(_ca3a,"doubletextbox");
var _ca3d=_ca3c.options;
var tb=_ca3c.doubletextbox;
var _ca3e=tb.find(".textbox-text");
_ca3d.readonly=_ca3b==undefined?true:_ca3b;
if(_ca3d.readonly){
_ca3e.triggerHandler("blur.textbox");
}
_ca3e.validatebox("readonly",_ca3d.readonly);
tb.removeClass("textbox-readonly").addClass(_ca3d.readonly?"textbox-readonly":"");
};
function _ca8f(_ca9a){
var _ca9b=$.data(_ca9a,"doubletextbox");
var tb=_ca9b.doubletextbox;
var _ca3d=tb.find(".textbox-text:eq(0)");
var _ca3e=tb.find(".textbox-text:eq(1)");
return _ca3d.validatebox("validate") && _ca3e.validatebox("validate");
}
$.fn.doubletextbox=function(_ca3f,_ca40){
if(typeof _ca3f=="string"){
var _ca41=$.fn.doubletextbox.methods[_ca3f];
if(_ca41){
return _ca41(this,_ca40);
}else{
return this.each(function(){
var _ca42=$(this).doubletextbox("doubletextbox");
_ca42.validatebox(_ca3f,_ca40);
});
}
}
_ca3f=_ca3f||{};
return this.each(function(){
var _ca43=$.data(this,"doubletextbox");
if(_ca43){
$.extend(_ca43.options,_ca3f);
if(_ca43.options.valueBegin!=undefined){
_ca43.options.originalValueBegin=_ca43.options.valueBegin;
}
if(_ca43.options.valueEnd!=undefined){
_ca43.options.originalValueEnd=_ca43.options.valueEnd;
}
}else{
var _ca4h = $.extend({},$.fn.doubletextbox.defaults,$.fn.doubletextbox.parseOptions(this),_ca3f);
_ca43=$.data(this,"doubletextbox",{options:_ca4h,doubletextbox:_ca2(this,_ca4h.separator,_ca4h.suffix)});
_ca43.options.originalValue=_ca43.options.value;
if(_ca43.options.value){
var _ca4v=_ca43.options.value.split(_ca43.options.separator);
if(_ca4v.length){
_ca43.options.originalValueBegin=_ca4v[0];
_ca43.options.originalValueEnd=_ca4v.length>1?_ca4v[1]:_ca4v[0];
_ca43.options.valueBegin=_ca4v[0];
_ca43.options.valueEnd=_ca4v.length>1?_ca4v[1]:_ca4v[0];
}
}
}
_ca6(this);
_ca27(this);
if(_ca43.options.doSize){
_ca11(this);
}
var _ca44b=_ca43.options.valueBegin;
var _ca44e=_ca43.options.valueEnd;
_ca43.options.valueBegin="";
_ca43.options.valueEnd="";
$(this).doubletextbox("initValue",[_ca44b,_ca44e]);
});
};
...
},setTextBegin:function(jq,_ca4e){
return jq.each(function(){
var _ca4f=$(this).doubletextbox("options");
var _ca50=$(this).doubletextbox("textboxbegin");
_ca4e=_ca4e==undefined?"":String(_ca4e);
if($(this).doubletextbox("getTextBegin")!=_ca4e){
_ca50.val(_ca4e);
}
_ca4f.valueBegin=_ca4e;
if(!_ca50.is(":focus")){
if(_ca4e){
_ca50.removeClass("textbox-prompt");
}else{
_ca50.val(_ca4f.promptBegin).addClass("textbox-prompt");
}
}
_ca50.validatebox("validate");
});
},setTextEnd:function(jq,_ca7e){
return jq.each(function(){
var _ca7f=$(this).doubletextbox("options");
var _ca71=$(this).doubletextbox("textboxend");
_ca7e=_ca7e==undefined?"":String(_ca7e);
if($(this).doubletextbox("getTextEnd")!=_ca7e){
_ca71.val(_ca7e);
}
_ca7f.valueEnd=_ca7e;
if(!_ca71.is(":focus")){
if(_ca7e){
_ca71.removeClass("textbox-prompt");
}else{
_ca71.val(_ca7f.promptEnd).addClass("textbox-prompt");
}
}
_ca71.validatebox("validate");
});
},initValue:function(jq,_ca51){
return jq.each(function(){
var _ca52=$.data(this,"doubletextbox");
var _ca51b="";
var _ca51e="";
if(!$.isArray(_ca51)){
_ca51 = _ca51.split(_ca52.options.separator);
}
if(_ca51.length){
_ca51b=_ca51[0];
_ca51e=_ca51.length>1?_ca51[1]:_ca51[0];
}
$(this).doubletextbox("setTextBegin",_ca51b);
$(this).doubletextbox("setTextEnd",_ca51e);
_ca52.doubletextbox.find(".textbox-value:eq(0)").val(_ca51b);
_ca52.doubletextbox.find(".textbox-value:eq(1)").val(_ca51e);
$(this).val(_ca51b+_ca52.options.separator+_ca51e);
});
},setValues:function(jq,_ca53){
return jq.each(function(){
var _ca54=$.data(this,"doubletextbox").options;
var _ca55=$(this).doubletextbox("getValueBegin");
var _ca55e=$(this).doubletextbox("getValueEnd");
$(this).doubletextbox("initValue",_ca53);
var _ca55f=$(this).doubletextbox("getValueBegin");
var _ca55ef=$(this).doubletextbox("getValueEnd");
if(_ca55f!=_ca55 || _ca55e!=_ca55ef){
_ca54.onChange.call(this,_ca53,[_ca55,_ca55e],"begin");
$(this).closest("form").trigger("_cachange",[this]);
}
});
},setValueBegin:function(jq,_ca53){
return jq.each(function(){
var _ca54=$.data(this,"doubletextbox").options;
var _ca55=$(this).doubletextbox("getValueBegin");
var _ca55e=$(this).doubletextbox("getValueEnd");
$(this).doubletextbox("initValue",[_ca53,_ca55e]);
if(_ca55!=_ca53){
_ca54.onChange.call(this,_ca53,_ca55,"begin");
$(this).closest("form").trigger("_cachange",[this]);
}
});
},setValueEnd:function(jq,_ca53){
return jq.each(function(){
var _ca54=$.data(this,"doubletextbox").options;
var _ca55b=$(this).doubletextbox("getValueBegin");
var _ca55=$(this).doubletextbox("getValueEnd");
$(this).doubletextbox("initValue",[_ca55b,_ca53]);
if(_ca55!=_ca53){
_ca54.onChange.call(this,_ca53,_ca55,"end");
$(this).closest("form").trigger("_cachange",[this]);
}
});
},getTextBegin:function(jq){
var _ca56=jq.doubletextbox("textboxbegin");
if(_ca56.is(":focus")){
return _ca56.val();
}else{
...
var _ca56=jq.doubletextbox("textboxend");
if(_ca56.is(":focus")){
return _ca56.val();
}else{
...
return jq.each(function(){
var _ca57=$(this).doubletextbox("options");
$(this).doubletextbox("setValueBegin",_ca57.originalValueBegin);
$(this).doubletextbox("setValueEnd",_ca57.originalValueEnd);
});
},getIcon:function(jq,_ca58){
return jq.data("doubletextbox").doubletextbox.find(".textbox-icon:eq("+_ca58+")");
},getTipX:function(jq,_ca59){
var _ca5a=jq.data("doubletextbox");
var _ca5b=_ca5a.options;
var tb=_ca5a.doubletextbox;
var _ca5c=tb.find(".textbox-text");
var _ca59=_ca59||_ca5b.tipPosition;
var p1=tb.offset();
var p2=_ca5c.offset();
var w1=tb.outerWidth();
var w2=_ca5c.outerWidth();
if(_ca59=="right"){
return w1-w2-p2.left+p1.left;
}else{
if(_ca59=="left"){
...
},getTipY:function(jq,_ca5d){
var _ca5e=jq.data("doubletextbox");
var _ca5f=_ca5e.options;
var tb=_ca5e.doubletextbox;
var _ca60=tb.find(".textbox-text");
var _ca5d=_ca5d||_ca5f.tipPosition;
var p1=tb.offset();
var p2=_ca60.offset();
var h1=tb.outerHeight();
var h2=_ca60.outerHeight();
if(_ca5d=="left"||_ca5d=="right"){
return (h1-h2-p2.top+p1.top)/2-(p2.top-p1.top)/2;
}else{
if(_ca5d=="bottom"){
return (h1-h2-p2.top+p1.top);
...
var _ca61=jq.doubletextbox("doubletextbox")[i==1?1:0];
var _ca62=0;
var end=0;
if(typeof _ca61.selectionStart=="number"){
_ca62=_ca61.selectionStart;
end=_ca61.selectionEnd;
}else{
if(_ca61.createTextRange){
var s=document.selection.createRange();
var _ca63=_ca61.createTextRange();
_ca63.setEndPoint("EndToStart",s);
_ca62=_ca63.text.length;
end=_ca62+s.text.length;
}
}
return {start:_ca62,end:end};
},setSelectionRange:function(jq,_ca64,i){
return jq.each(function(){
var _ca65=$(this).doubletextbox("doubletextbox")[i==1?1:0];
var _ca66=_ca64.start;
var end=_ca64.end;
if(_ca65.setSelectionRange){
_ca65.setSelectionRange(_ca66,end);
}else{
if(_ca65.createTextRange){
var _ca67=_ca65.createTextRange();
_ca67.collapse();
_ca67.moveEnd("character",end);
_ca67.moveStart("character",_ca66);
_ca67.select();
}
}
});
...
var t=$(e.data.target);
var _ca69=t.doubletextbox("options");
if(t.doubletextbox("getValueBegin")!=_ca69.valueBegin){
t.doubletextbox("setValueBegin",_ca69.valueBegin);
}
if(t.doubletextbox("getValueEnd")!=_ca69.valueEnd){
t.doubletextbox("setValueEnd",_ca69.valueEnd);
}
},keydown:function(e){
if(e.keyCode==13){
var t=$(e.data.target);
...
}},onChange:function(_ca6a,_ca6b,_ca6g){
},onResizing:function(_ca6c,_ca6d){
},onResize:function(_ca6e,_ca6f){
},onClickButton:function(){
},onClickIcon:function(_ca70){
}},{originalValueBegin:"",originalValueEnd:"",promptBegin:"",promptEnd:"",val:function(_ca80){
var _ca8a = $(_ca80).closest(".textbox").prev();
var _ca81 = $(_ca8a).find(".textbox-value:eq(0)").val();
var _ca82 = $(_ca8a).find(".textbox-value:eq(1)").val();
if(_ca81 && _ca82){
return _ca81+_ca82;
}
if(_ca81){
...
function _cb2(_cb3){
var _cb4=$.data(_cb3,"doublecombo");
var _cb5=_cb4.options;
if(!_cb4.panel){
_cb4.panel=$("<div class=\"combo-panel\"></div>").appendTo("body");
_cb4.panel.panel({minWidth:_cb5.panelMinWidth,maxWidth:_cb5.panelMaxWidth,minHeight:_cb5.panelMinHeight,maxHeight:_cb5.panelMaxHeight,doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
var _cb6=$(this).panel("options").comboTarget;
var _cb7=$.data(_cb6,"doublecombo");
if(_cb7){
_cb7.options.onShowPanel.call(_cb6);
}
},onBeforeClose:function(){
_cb1($(this).parent());
},onClose:function(){
var _cb8=$(this).panel("options").comboTarget;
var _cb9=$(_cb8).data("doublecombo");
if(_cb9){
_cb9.options.onHidePanel.call(_cb8);
}
}});
}
var _cba=$.extend(true,[],_cb5.icons);
if(_cb5.hasDownArrow){
_cba.push({iconCls:"combo-arrow",handler:function(e){
_cbf(e.data.target);
}});
}
$(_cb3).addClass("combo-f").doubletextbox($.extend({},_cb5,{icons:_cba,onChange:function(){
}}));
$(_cb3).attr("comboName",$(_cb3).attr("textboxName"));
_cb4.doublecombo=$(_cb3).next();
_cb4.doublecombo.addClass("combo");
};
function _cbb(_cbc){
var _cbd=$.data(_cbc,"doublecombo");
var _cbe=_cbd.options;
var p=_cbd.panel;
if(p.is(":visible")){
p.panel("close");
}
...
$(_cbc).doubletextbox("destroy");
};
function _cbf(_cb10){
var _cb11=$.data(_cb10,"doublecombo").panel;
if(_cb11.is(":visible")){
var _cb12=_cb11.doublecombo("doublecombo");
_cb13(_cb12);
if(_cb12!=_cb10){
$(_cb10).doublecombo("showPanel");
}
}else{
var p=$(_cb10).closest("div.combo-p").children(".combo-panel");
$("div.combo-panel:visible").not(_cb11).not(p).panel("close");
$(_cb10).doublecombo("showPanel");
}
$(_cb10).doublecombo("textboxbegin").focus();
};
function _cb1(_cb14){
$(_cb14).find(".combo-f").each(function(){
...
function _cb15(e){
var _cb16=e.data.target;
var _cb17=$.data(_cb16,"doublecombo");
var _cb18=_cb17.options;
if(!_cb18.editable){
_cbf(_cb16);
}else{
var p=$(_cb16).closest("div.combo-p").children(".combo-panel");
$("div.combo-panel:visible").not(p).each(function(){
var _cb19=$(this).doublecombo("doublecombo");
if(_cb19!=_cb16){
_cb13(_cb19);
}
});
...
function _cb1a(e){
var _cb1b=e.data.target;
var t=$(_cb1b);
var _cb1c=t.data("doublecombo");
var _cb1d=t.doublecombo("options");
_cb1c.panel.panel("options").comboTarget=_cb1b;
switch(e.keyCode){
case 38:
_cb1d.keyHandler.up.call(_cb1b,e);
break;
case 40:
_cb1d.keyHandler.down.call(_cb1b,e);
break;
case 37:
_cb1d.keyHandler.left.call(_cb1b,e);
break;
case 39:
_cb1d.keyHandler.right.call(_cb1b,e);
break;
case 13:
e.preventDefault();
_cb1d.keyHandler.enter.call(_cb1b,e);
return false;
case 9:
case 27:
_cb13(_cb1b);
...
if(_cb1d.editable){
if(_cb1c.timer){
clearTimeout(_cb1c.timer);
}
_cb1c.timer=setTimeout(function(){
var q1=t.doublecombo("getTextBegin");
var q2=t.doublecombo("getTextEnd");
var q=undefined;
if(_cb1c.previousText1!=q1){
_cb1c.previousText1=q1;
q=q1;
}
if(_cb1c.previousText2!=q2){
_cb1c.previousText2=q2;
q=q2;
}
if(q){
t.doublecombo("showPanel");
_cb1d.keyHandler.query.call(_cb1b,q,e);
...
function _cb1e(_cb1f){
var _cb20=$.data(_cb1f,"doublecombo");
var _cb21=_cb20.doublecombo;
var _cb22=_cb20.panel;
var _cb23=$(_cb1f).doublecombo("options");
var _cb24=_cb22.panel("options");
_cb24.comboTarget=_cb1f;
if(_cb24.closed){
_cb22.panel("panel").show().css({zIndex:($.fn.menu?$.fn.menu.defaults.zIndex++:($.fn.window?$.fn.window.defaults.zIndex++:99)),left:-999999});
_cb22.panel("resize",{width:(_cb23.panelWidth?_cb23.panelWidth:_cb21._outerWidth()),height:_cb23.panelHeight});
_cb22.panel("panel").hide();
_cb22.panel("open");
}
(function(){
if(_cb24.comboTarget==_cb1f&&_cb22.is(":visible")){
_cb22.panel("move",{left:_cb25(),top:_cb26()});
setTimeout(arguments.callee,200);
}
})();
function _cb25(){
var _cb27=_cb21.offset().left;
if(_cb23.panelAlign=="right"){
_cb27+=_cb21._outerWidth()-_cb22._outerWidth();
}
if(_cb27+_cb22._outerWidth()>$(window)._outerWidth()+$(document).scrollLeft()){
_cb27=$(window)._outerWidth()+$(document).scrollLeft()-_cb22._outerWidth();
}
if(_cb27<0){
_cb27=0;
}
...
function _cb26(){
var top=_cb21.offset().top+_cb21._outerHeight();
if(top+_cb22._outerHeight()>$(window)._outerHeight()+$(document).scrollTop()){
top=_cb21.offset().top-_cb22._outerHeight();
}
if(top<$(document).scrollTop()){
top=_cb21.offset().top+_cb21._outerHeight();
}
return top;
};
};
function _cb13(_cb28){
var _cb29=$.data(_cb28,"doublecombo").panel;
_cb29.panel("close");
};
function _cb2f(_cb30){
var _cb31=$.data(_cb30,"doublecombo");
var _cb32=_cb31.options;
var _cb33=_cb31.doublecombo;
var _cb34=[];
_cb33.find(".textbox-value").each(function(){
_cb34.push($(this).val());
});
return _cb34;
};
function _cb35(_cb36,_cb37){
var _cb38=$.data(_cb36,"doublecombo");
var _cb39=_cb38.options;
var _cb3a=_cb38.doublecombo;
if(!$.isArray(_cb37)){
_cb37=_cb37.split(_cb39.separator);
}
var _cb3b=_cb2f(_cb36);
$(_cb36).doublecombo("initValue",_cb37);
var _cb40=(function(){
if(_cb3b.length!=_cb37.length){
return true;
}
for(var i=0;i<_cb37.length;i++){
if(_cb37[i]!=_cb3b[i]){
return true;
}
}
...
if(_cb40){
_cb39.onChange.call(_cb36,_cb37,_cb3b);
$(_cb36).closest("form").trigger("_cbchange",[_cb36]);
}
};
function _cb47(_cb48){
var _cb49=$.data(_cb48,"doublecombo").options;
var _cb4a=_cb49.onChange;
_cb49.onChange=function(){
};
_cb35(_cb48,[_cb49.valueBegin,_cb49.valueEnd]);
_cb49.onChange=_cb4a;
};
$.fn.doublecombo=function(_cb4b,_cb4c){
if(typeof _cb4b=="string"){
var _cb4d=$.fn.doublecombo.methods[_cb4b];
if(_cb4d){
return _cb4d(this,_cb4c);
}else{
return this.doubletextbox(_cb4b,_cb4c);
}
}
_cb4b=_cb4b||{};
return this.each(function(){
var _cb4e=$.data(this,"doublecombo");
if(_cb4e){
$.extend(_cb4e.options,_cb4b);
if(_cb4e.options.valueBegin!=undefined){
_cb4e.options.originalValueBegin=_cb4e.options.valueBegin;
}
if(_cb4e.options.valueEnd!=undefined){
_cb4e.options.originalValueEnd=_cb4e.options.valueEnd;
}
}else{
_cb4e=$.data(this,"doublecombo",{options:$.extend({},$.fn.doublecombo.defaults,$.fn.doublecombo.parseOptions(this),_cb4b),previousText1:"",previousText2:""});
_cb4e.options.originalValue=_cb4e.options.value;
if(_cb4e.options.value){
var _cb4v=_cb4e.options.value.split(_cb4e.options.separator);
if(_cb4v.length){
_cb4e.options.originalValueBegin=_cb4v[0];
_cb4e.options.originalValueEnd=_cb4v.length>1?_cb4v[1]:_cb4v[0];
_cb4e.options.valueBegin=_cb4v[0];
_cb4e.options.valueEnd=_cb4v.length>1?_cb4v[1]:_cb4v[0];
}
}
}
_cb2(this);
...
var _cb4f=jq.doubletextbox("options");
return $.extend($.data(jq[0],"doublecombo").options,{width:_cb4f.width,height:_cb4f.height,disabled:_cb4f.disabled,readonly:_cb4f.readonly});
...
return jq.each(function(){
var _cb52=$.data(this,"doublecombo").options;
$(this).doublecombo("setValues",[_cb52.originalValueBegin,_cb52.originalValueEnd]);
});
},getValues:function(jq){
return _cb2f(jq[0]);
},setValues:function(jq,_cb54){
return jq.each(function(){
_cb35(this,_cb54);
});
}};
$.fn.doublecombo.parseOptions=function(_cb56){
var t=$(_cb56);
return $.extend({},$.fn.doubletextbox.parseOptions(_cb56),$.parser.parseOptions(_cb56,["panelAlign",{panelWidth:"number",hasDownArrow:"boolean",delay:"number",reversed:"boolean",selectOnNavigation:"boolean"},{panelMinWidth:"number",panelMaxWidth:"number",panelMinHeight:"number",panelMaxHeight:"number"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined)});
};
$.fn.doublecombo.defaults=$.extend({},$.fn.doubletextbox.defaults,{inputEvents:{click:_cb15,keydown:_cb1a,paste:_cb1a,drop:_cb1a,blur:$.fn.doubletextbox.defaults.inputEvents.blur},panelWidth:null,panelHeight:200,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",reversed:false,selectOnNavigation:true,hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
},onChange:function(_cb57,_cb58){
}});
})(jQuery);
(function($){
function _cc1(_cc2){
var _cc3=$.data(_cc2,"doubledatebox");
var _cc4=_cc3.options;
$(_cc2).addClass("datebox-f").doublecombo($.extend({},_cc4,{onShowPanel:function(){
_cc5(this);
_cc6(this);
_cc7(this);
_cc18(this,[$(this).doubledatebox("getValueBegin"),$(this).doubledatebox("getValueEnd")],true);
_cc4.onShowPanel.call(this);
}}));
if(!_cc3.calendar){
var _cc8=$(_cc2).doublecombo("panel").css("overflow","hidden");
_cc8.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner datebox-calendar-inner1\"></div>").prependTo(_cc8);
var cb=$("<div class=\"datebox-calendar-inner datebox-calendar-inner2\"></div>").insertAfter(cc);
if(_cc4.sharedCalendar){
var c=$(_cc4.sharedCalendar);
if(!c[0].pholder){
c[0].pholder=$("<div class=\"calendar-pholder\" style=\"display:none\"></div>").insertAfter(c);
}
var b = c.clone();
...
_cc3.calendar1=$("<div></div>").appendTo(cc).calendar();
_cc3.calendar2=$("<div></div>").appendTo(cb).calendar();
}
$.extend(_cc3.calendar1.calendar("options"),{fit:true,border:false,onSelect:function(_cc9){
var _cca=this.target;
var _cc52=$(_cca).doubledatebox("options");
var _cc53=$(_cca).doubledatebox("panel");
var _cc54=_cc53.find(".datebox-button-middle");
var _cc55=$.data(_cca,"doubledatebox").calendar1;
_cc54.find("td:eq(0)").html(_cc52.beginText+_cc52.showFormatter.call(_cca,_cc55.calendar("options").current));
}});
$.extend(_cc3.calendar2.calendar("options"),{fit:true,border:false,onSelect:function(_cc9){
var _cca=this.target;
var _cc56=$(_cca).doubledatebox("options");
var _cc57=$(_cca).doubledatebox("panel");
var _cc58=_cc57.find(".datebox-button-middle");
var _cc59=$.data(_cca,"doubledatebox").calendar2;
_cc58.find("td:eq(1)").html(_cc56.endText+_cc56.showFormatter.call(_cca,_cc59.calendar("options").current));
}});
}
$(_cc2).doublecombo("doubletextbox").parent().addClass("datebox");
$(_cc2).doubledatebox("initValue");
function _cc5(_ccc){
var _ccd=$(_ccc).doubledatebox("options");
var _cce=$(_ccc).doublecombo("panel");
_cce.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _ccf=parseInt($(e.target).attr("datebox-button-index"));
_ccd.buttons[_ccf].handler.call(e.target,_ccc);
}
if($(e.target).hasClass("datebox-button-b")){
var _ccf=parseInt($(e.target).attr("datebox-button-index"));
_ccd.topButtons[_ccf].handler.call(e.target,_ccc);
}
});
};
function _cc6(_cc10){
var _cc11=$(_cc10).doublecombo("panel");
var opts=$(_cc10).doubledatebox("options");
if(!_cc11.children("div.datebox-button-middle").length){
var _cc49=$("<div class=\"datebox-button datebox-button-middle\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr><td></td><td></td></tr></table></div>").prependTo(_cc11);
_cc49.find("td").css({width:"25%",textAlign:"left"});
_cc49.find("td:eq(0)").html(opts.beginText);
_cc49.find("td:eq(1)").html(opts.endText);
}
if(!_cc11.children("div.datebox-button-bottom").length){
var _cc12=$("<div class=\"datebox-button datebox-button-bottom\"></div>").appendTo(_cc11);
for(var i=0;i<_cc4.buttons.length;i++){
var btn=_cc4.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:;\"></a>").html($.isFunction(btn.text)?btn.text(_cc10):btn.text).appendTo(_cc12);
t.attr("datebox-button-index",i);
}
}
if(!_cc11.children("div.datebox-button-top").length && _cc4.topButtons.length){
var _cc60=$("<div class=\"datebox-button datebox-button-top\"></div>").prependTo(_cc11);
for(var i=0;i<_cc4.topButtons.length;i++){
var btn=_cc4.topButtons[i];
var t=$("<a class=\"datebox-button-b\" href=\"javascript:;\"></a>").html(btn.text).appendTo(_cc60);
t.attr("datebox-button-index",i);
}
}
};
function _cc7(_cc13){
var _cc14=$(_cc13).doublecombo("panel");
var cc=_cc14.children("div.datebox-calendar-inner");
cc.css({display:"inline-block"});
_cc14.children().not(cc)._outerWidth(_cc14.width());
cc._outerWidth(_cc14.width()/2);
_cc3.calendar1.appendTo(cc[0]);
_cc3.calendar1[0].target=_cc13;
_cc3.calendar2.appendTo(cc[1]);
_cc3.calendar2[0].target=_cc13;
if(_cc4.panelHeight!="auto"){
var _cc15=_cc14.height();
_cc14.children().not(cc).each(function(){
_cc15-=$(this).outerHeight();
});
cc._ccouterHeight(_cc15);
}
_cc3.calendar1.calendar("resize");
_cc3.calendar2.calendar("resize");
};
};
function _cc16(_cc17,q){
_cc18(_cc17,q,true);
};
function _cc19(_cc1a){
var _cc1b=$.data(_cc1a,"doubledatebox");
var _cc1c=_cc1b.options;
var _cc1d=_cc1b.calendar1.calendar("options").current;
var _cc1d2=_cc1b.calendar2.calendar("options").current;
if(_cc1d || _cc1d2){
_cc18(_cc1a,[_cc1c.formatter.call(_cc1a,_cc1d),_cc1c.formatter.call(_cc1a,_cc1d)]);
$(_cc1a).doubletextbox("hidePanel");
}
};
function _cc18(_cc1e,_cc1f,_cc20){
var _cc21=$.data(_cc1e,"doubledatebox");
var _cc22=_cc21.options;
var _cc23=_cc21.calendar1;
var _cc33=_cc21.calendar2;
var _cc50=$(_cc1e).doubledatebox("panel");
if(!$.isArray(_cc1f)){
_cc1f=_cc1f.split(_cc22.separator);
}
if(!_cc1f.length){
_cc1f=["",""];
}else if(_cc1f.length==1){
_cc1f.push("");
}
_cc23.calendar("moveTo",_cc22.parser.call(_cc1e,_cc1f[0]));
_cc33.calendar("moveTo",_cc22.parser.call(_cc1e,_cc1f[1]));
var _cc51=_cc50.find(".datebox-button-middle");
_cc51.find("td:eq(0)").html(_cc22.beginText+_cc22.showFormatter.call(_cc1e,_cc23.calendar("options").current));
_cc51.find("td:eq(1)").html(_cc22.endText+_cc22.showFormatter.call(_cc1e,_cc33.calendar("options").current));
if(_cc20){
$(_cc1e).doublecombo("setValues",_cc1f);
}else{
if(_cc1f[0]){
_cc1f[0]=_cc22.formatter.call(_cc1e,_cc23.calendar("options").current);
}
if(_cc1f[1]){
_cc1f[1]=_cc22.formatter.call(_cc1e,_cc33.calendar("options").current);
}
$(_cc1e).doublecombo("setValues",_cc1f);
}
};
$.fn.doubledatebox=function(_cc24,_cc25){
if(typeof _cc24=="string"){
var _cc26=$.fn.doubledatebox.methods[_cc24];
if(_cc26){
return _cc26(this,_cc25);
}else{
return this.doublecombo(_cc24,_cc25);
}
}
_cc24=_cc24||{};
return this.each(function(){
var _cc27=$.data(this,"doubledatebox");
if(_cc27){
$.extend(_cc27.options,_cc24);
}else{
$.data(this,"doubledatebox",{options:$.extend({},$.fn.doubledatebox.defaults,$.fn.doubledatebox.parseOptions(this),_cc24,{editable:false})});
}
_cc1(this);
});
};
$.fn.doubledatebox.methods={options:function(jq){
var _cc28=jq.doublecombo("options");
return $.extend($.data(jq[0],"doubledatebox").options,{width:_cc28.width,height:_cc28.height,originalValue:_cc28.originalValue,originalValuebegin:_cc28.originalValueBegin,originalValueEnd:_cc28.originalValueEnd,disabled:_cc28.disabled,readonly:_cc28.readonly});
...
},initValue:function(jq,_cc2a){
return jq.each(function(){
var _cc2b=$(this).doubledatebox("options");
var _cc2c=_cc2b.valueBegin;
if(_cc2c){
_cc2c=_cc2b.formatter.call(this,_cc2b.parser.call(this,_cc2c));
}
var _cc3c=_cc2b.valueEnd;
if(_cc3c){
_cc3c=_cc2b.formatter.call(this,_cc2b.parser.call(this,_cc3c));
}
_cc18(this,[_cc2c,_cc3c],true);
});
},setValues:function(jq,_cc2d){
return jq.each(function(){
_cc18(this,_cc2d);
});
},reset:function(jq){
return jq.each(function(){
var _cc2e=$(this).doubledatebox("options");
$(this).doubledatebox("setValues",[_cc2e.originalValueBegin,_cc2e.originalValueEnd]);
});
}};
$.fn.doubledatebox.parseOptions=function(_cc2f){
return $.extend({},$.fn.doublecombo.parseOptions(_cc2f),$.parser.parseOptions(_cc2f,["sharedCalendar"]));
};
...
_cc16(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_cc40){
return $(_cc40).doubledatebox("options").okText;
},handler:function(_cc41){
var _cc4b=$.data(_cc41,"doubledatebox");
var _cc42=_cc4b.options;
var _cc43=_cc4b.calendar1.calendar("options").current;
var _cc44=_cc4b.calendar2.calendar("options").current;
if(_cc43 && _cc44){
var _cc45 = _cc42.formatter.call(_cc41,_cc43);
var _cc46 = _cc42.formatter.call(_cc41,_cc44);
_cc18(_cc41,[_cc45,_cc46],true);
$(_cc41).doublecombo("hidePanel");
}
}},{text:function(_cc47){
return $(_cc47).doubledatebox("options").closeText;
},handler:function(_cc48){
$(this).closest("div.combo-panel").panel("close");
}}],topButtons:[],formatter:function(_cc34){
var y=_cc34.getFullYear();
var m=_cc34.getMonth()+1;
var d=_cc34.getDate();
return (m<10?("0"+m):m)+"/"+(d<10?("0"+d):d)+"/"+y;
},parser:function(s){
if(!s){
...
},beginText:"Start Date:",endText:"End Date:",showFormatter:function(_cc34){
var y=_cc34.getFullYear();
var m=_cc34.getMonth()+1;
var d=_cc34.getDate();
return (m<10?("0"+m):m)+"/"+(d<10?("0"+d):d)+"/"+y;
},onSelect:function(_cc35){
}});
})(jQuery);
